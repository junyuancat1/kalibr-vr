...
if __name__ == "__main__":        
    ...
    target_image_color = cv2.imread("/home/shadowlly/pics/cam0/IMG_0242.JPG")    
    ...
    for corner in cornersImage:
        ...
        cv2.putText(target_image_color, str(corner_index), (int(corner[0]), int(corner[1])), cv2.FONT_HERSHEY_SIMPLEX, fontScale=0.75, color=(0, 0, 255), thickness=2)
        corner_index += 1
