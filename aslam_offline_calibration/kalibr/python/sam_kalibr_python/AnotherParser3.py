...
if __name__ == "__main__":        
    ...
    #左侧板
    target_board3_file = "april_6x6_3.yaml"
    
    cmd_parse = "python3 ./ParseApril.py --target {} --cam ~/kalibr/devel/lib/kalibr/camchain-precision_camera.yaml >> {}"
    
    cmd_parse_april_board3 = cmd_parse.format(target_board3_file, "finded_tag_indexs_board3.txt")
    
    os.system(cmd_parse_april_board3)
    ...
    fname = "finded_tag_indexs_board3.txt"
    numbers = []
    ...
    for i in range(0,6):
        ...
        for j in range(0,6):
            ...
            if tag_id in numbers:
                ...
                april_box_list.append(AprilBox(3, tag_id, cornersImage[left_up_corner_index], cornersImage[right_up_corner_index], cornersImage[left_bottom_corner_index], cornersImage[right_bottom_corner_index]))
